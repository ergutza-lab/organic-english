...
function paginaSinConexion() {
  return new Response(
    ...
    'No pudimos cargar tu Organic App. Revisa tu conexión a internet (WiFi o datos) e intenta de nuevo.</p>' +
